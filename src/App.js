...
function App() {
  ...
  const contractAddress = '0xfD91B90a73227D68c5F99341d3325f9C8b995110';
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        ...
        <img className="inline p-3 ml-2" src="https://i.postimg.cc/CxNQF0PR/WRCoin.png" alt="Meme Coin" width="80" height="50" />
      </h2>
